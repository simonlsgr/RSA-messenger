...
keyatemp = 
...
if __name__ == "__main__":
    ...
    encrypted_out = main().encrypt(message, keyntemp, keyatemp)
    ...
    testdecrypt = main().decrypt(5149365399281403901788393586564312130822347262, 294866935483077640986398207168250500966, 19, 16, 2697881001866361037527085348, 10145797184018515033932830278, 16, 16, 30519548451880718516112605203)
