...
class ChatFrame(ctk.CTkFrame):
    def __init__(self, master=None):
        ...
        self.message_input.pack(side="bottom", pady=10, padx=20, anchor="sw")
        """self.btn_send = ctk.CTkButton(self, text="Send", width=10, height=1)
        self.btn_send.pack(side="right", pady=10, padx=5, anchor="se")"""
